...
"""Pipecat Quickstart – AssemblyAI Speech-to-Speech.

Sample agent: Facebook Ads intake for a small business.
The agent collects a caller's name, callback number, and monthly budget,
then saves the lead via a tool call.
...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    llm = AssemblyAIRealtimeLLMService(
        url=os.getenv("ASSEMBLYAI_REALTIME_URL", ""),
